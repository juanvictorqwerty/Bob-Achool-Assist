...
export default function SignUp(){
    ...
    const handlePasswordConfirmChange = (e:{target:{value: SetStateAction<string>;}})=>{
    ...
    <div className="max-w-md relative flex flex-col p-4 rounded-md text-black bg-gray-200">
        <div className="text-2xl font-bold mb-2 text-[#1e0e4b] text-center">Welcome to <span className="text-[#7747ff]">App</span></div>
    ...
    <form className="flex flex-col gap-3">
        ...
        />
        <label  className="block text-gray-600 cursor-text text-sm leading-[140%] font-normal mb-2">Password Confirm</label>
        <input type="text" 
        className="rounded border border-gray-200 bg-white text-sm w-full font-normal leading-[18px] text-black tracking-[0px] appearance-none block h-11 m-0 p-2.75 focus:ring-2 ring-offset-2 ring-gray-900 outline-0"
